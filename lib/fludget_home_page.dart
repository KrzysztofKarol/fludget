              ...
              child: Column(
                ...
                children: <Widget>[
                  StreamBuilder<QuerySnapshot>(
                    stream:
                        Firestore.instance.collection('widgets').snapshots(),
                    ...
                    builder: (context, snapshot) {
                      ...
                      return InkWell(
                        child: FludgetTile(
                            name: snapshot.data.documents[0].data["name"],
                            imageUrl:
                                "https://www.clipartmax.com/png/full/36-361084_clipart-sammlung-download.png",
                  ...
                  StreamBuilder<QuerySnapshot>(
                    stream:
                        Firestore.instance.collection('packages').snapshots(),
                    builder: (context, snapshot) {
                      if (!snapshot.hasData) return LinearProgressIndicator();
                      ...
                      return InkWell(
                        child: FludgetTile(
                            name: snapshot.data.documents[0].data["name"],
                            imageUrl:
                                "http://dartdoc.takyam.com/logos/dart-logo.png",
